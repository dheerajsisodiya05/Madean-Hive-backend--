...
import com.madeanhive.domain.PaymentStatus;
import com.madeanhive.exception.OrderException;
import com.madeanhive.model.*;
import com.madeanhive.model.*;
import com.madeanhive.repository.AddressRepository;
import com.madeanhive.repository.OrderItemRepository;
import com.madeanhive.repository.OrderRepository;
import com.madeanhive.repository.UserRepository;

import com.madeanhive.service.CartService;
import com.madeanhive.service.OrderService;
...
//		shippAddress.setUser(user);
	...
	public Order findOrderById(Long orderId) throws OrderException {
		Long orderIdNonNull = orderId != null ? orderId : 0L;
		Optional<Order> opt=orderRepository.findById(orderIdNonNull);
	...
	public void deleteOrder(Long orderId) throws OrderException {
		...
		Long orderIdNonNull = orderId != null ? orderId : 0L;
		orderRepository.deleteById(orderIdNonNull);
