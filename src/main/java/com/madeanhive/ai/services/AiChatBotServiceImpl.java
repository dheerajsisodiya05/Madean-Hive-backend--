...
import com.madeanhive.mapper.OrderMapper;
import com.madeanhive.mapper.ProductMapper;
...
import com.madeanhive.repository.OrderRepository;
import com.madeanhive.repository.ProductRepository;
import com.madeanhive.repository.UserRepository;
import com.madeanhive.response.ApiResponse;
import com.madeanhive.response.FunctionResponse;
...
public class AiChatBotServiceImpl implements AiChatBotService {
    ...
    private FunctionResponse processFunctionCall(JSONObject functionCall,
        ...
        // JSONObject args = functionCall.getJSONObject("args"); // Parsing args for function calls

        FunctionResponse res = new FunctionResponse();
        res.setFunctionName(functionName);
        Long userIdNonNull = userId != null ? userId : 0L;
        User user=userRepository.findById(userIdNonNull).orElse(null);
...
//                Long productId = Long.parseLong(args.getString("productId"));
                Long productIdNonNull = productId != null ? productId : 0L;
                Product product = productRepository.findById(productIdNonNull).orElseThrow(
